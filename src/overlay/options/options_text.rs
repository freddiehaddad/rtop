...
pub fn desc(key: ConfigKey) -> &'static [&'static str] {
    match key {
        ...
        ConfigKey::Bool(BoolKey::ProcColors) => &[
            "Color the CPU and MEM columns by value.",
            "",
            "Each number takes a warmer color as it",
            "climbs, so heavy processes stand out while",
            "the pid, program and command columns stay",
            "neutral.",
            "",
            "Default: on.",
        ],
        ...
        ConfigKey::Int(IntKey::GpuUpdateMs) => &[
            ...
            "",
            "Overrides the global Refresh Interval for",
            "the GPU widget. 0 inherits the global",
            "value. Applies to every detected device.",
            "",
            "Default: 0 (inherit).",
            "Range: 0 to 86,400,000 ms.",
        ],
