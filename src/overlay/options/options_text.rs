...
pub fn desc(key: ConfigKey) -> &'static [&'static str] {
    match key {
        ...
        ConfigKey::Bool(BoolKey::ShowStatusbar) => &[
            ...
            "1-row statusbar at the bottom of every preset.",
            "Hides every statusbar item; the row reclaims",
        ...
        ConfigKey::Bool(BoolKey::StatusbarShowPreset) => &[
            ...
            "left section. A trailing `*` after the preset",
            "name marks an active widget filter (cleared",
            "by Shift+R).",
            "",
            "Default: on.",
        ],
        ...
        ConfigKey::Bool(BoolKey::StatusbarShowClock) => &[
            ...
            "right section using `statusbar_clock_format`.",
