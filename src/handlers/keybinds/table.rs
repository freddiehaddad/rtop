...
pub(crate) static BINDINGS: &[Binding] = &[
    ...
    Binding {
        keys: &[
            KeySpec::Always(Key::Char('r')),
            KeySpec::Always(Key::Char('s')),
            KeySpec::Always(Key::Char('c')),
            KeySpec::Always(Key::Char('m')),
            KeySpec::Always(Key::Char('n')),
            KeySpec::Always(Key::Char('p')),
            KeySpec::Always(Key::Char('g')),
            KeySpec::Always(Key::Char('d')),
        ],
        states: OPTIONS,
        help: None,
        action: options::cat_select_hotkey_action,
    },
    Binding {
        keys: &[KeySpec::Always(Key::Up), KeySpec::VimOnly(Key::Char('k'))],
        states: OPTIONS,
